...
while current_run < number_of_runs:
	...
	downloaded_file = subprocess.call('python tftp.py -g ' + str(file_to_dl) + " rabbit.it.uu.se" + str(portNumber), shell=True)
...
subprocess.call("echo total time: " + str(total_time) + " FileSize: " + str(file_to_dl) + " Portnumber: " + str(portNumber) " >> result.txt", shell=True)
